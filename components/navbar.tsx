...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`flex w-full max-md:bg-black md:bg-black/65 md:backdrop-blur-lg h-14 border-b border-white/30 items-center justify-between lg:justify-around text-white sticky top-0 z-50 max-md:px-2 py-2  md:py-5 transition-all duration-300`}
      >
