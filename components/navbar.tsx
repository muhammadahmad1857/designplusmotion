...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`flex max-md:bg-black md:bg-black/10 md:backdrop-blur-lg h-14  border-b border-white/30 items-center justify-between lg:justify-around  text-white sticky top-0 z-50 p-5 transition-all duration-300`}
      >
