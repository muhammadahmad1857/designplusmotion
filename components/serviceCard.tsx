...
const ServiceCard = ({ title, data }: ComponentProps) => {
  return (
    <RevealOnScroll>
      <div className="border max-md:w-full hover:border-main/50 transition-colors duration-300 border-main/25 rounded-lg shadow-lg glassmorphism backdrop-blur-lg sm:p-20 p-10">
